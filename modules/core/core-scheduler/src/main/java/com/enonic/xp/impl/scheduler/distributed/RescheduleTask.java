    ...
    implements SchedulableTask
{
    ...
    private void doRun()
    {
        ...
        OsgiSupport.withService( SchedulerExecutorService.class, SchedulerExecutorService::disposeAllDone );

        final Set<String> liveTasks =
            OsgiSupport.withService( SchedulerExecutorService.class, scheduler -> scheduler.getAllFutures().keySet() );
